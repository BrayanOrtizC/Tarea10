...
A = [[1, -1, 2, -1, 6], [1, 0, -1, 1, 4], [2, 1, 3, -4, -2], [0, -1, 1, -1, 5]]



solucionA, row_swapsA = eliminacion_gaussiana(A)
...
print("La solución del sistema de ecuaciones es:", solucionA)

B = [[1, -1, 2, -1, 1], [1, 0, -1, 1, 1], [2, 1, 3, -4, 2], [0, -1, 1, -1, -1]]

solucionB, row_swapsB = eliminacion_gaussiana(B)
...
print("La solución del sistema de ecuaciones es:", solucionB)
